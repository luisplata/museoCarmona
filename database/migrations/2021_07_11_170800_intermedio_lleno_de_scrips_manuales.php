...
class IntermedioLlenoDeScripsManuales extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("CREATE TABLE `info` (
          ...
          DB::statement("INSERT INTO `info` (`id`, `whastapp`, `call`, `facebook`, `instagram`, `mail`, `hours`, `days`, `address`, `city`, `phone`, `phone_2`, `latitud`, `longitud`, `link_buy`, `created_at`, `updated_at`) VALUES (1,'3024136600','3024136600','https://www.facebook.com/carmonamuseo','https://www.instagram.com/museocarmona','info@museocarmona.com','De 10:00 a.m a 10:00 p.m','De martes a domingo','Carrera 2 # 36 - 86','Centro histórico de Cartagena, Playa de la artillería - cuartel de la artillería, carrera 2da','(+57) 302 413 6600','(+57) 315 7312 843','10.425530','-75.552967','https://carmonagallery.com/artist/14','2020-10-03 16:46:51','2020-10-13 21:02:39');");
          ...
          DB::statement("CREATE TABLE `projects` (
            ...
            `medida` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
